...
def exp_n_subnetwork(args):
    cmds = [
        ...
        'python3 main.py --scenario=plot_boxplot --metric=reward',
        'python3 main.py --scenario=plot_boxplot --metric=mean_capacity',
        'python3 main.py --scenario=plot_boxplot --metric=min_capacity',
    ]
    N = [10, 20, 40, 80]
