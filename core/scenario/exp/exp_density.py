...
def exp_density(args):
    cmds = [
        ...
        # 'python3 main.py --scenario=plot_metric --n_smooth=50 --n_subnetwork=20 --metric=mean_capacity',
        # 'python3 main.py --scenario=plot_metric --n_smooth=50 --n_subnetwork=20 --metric=min_capacity',
    ]
